            ...
            function(d) {
                ...
                if (typeof(d.info) != 'undefined') {
                    ...
                    if (d.member == 1) {
                        ...
                        code += '<div class="room-user-path"><img id="roomUserPath" src="' + d.room_owner.path + '" onerror="this.src=\'http://cdn.lfzgame.com/images/ucenter/user.png\'"></div>';
                        ...
                        if (win.version == '1.0.0') {
                            ...
                            if (user_list.length > 5) {
                                ...
                                for (var n in user_list) {
                                    ...
                                    code += '<img src="' + user_list[n].path + '" alt="" onerror="this.src=\'http://cdn.lfzgame.com/images/ucenter/user.png\'"><span>' + user_list[n].nickname + '</span>';
                                    code += '</div>';
                                    joinUser += code;
                                }
                            } else {
...
function createRanking(data, func) {
    ...
    for (var i in users) {
        if (/\/\/[064]{1,2}$/.test(users[i].path)) pics.push('http://cdn.lfzgame.com/images/default_head.png');
    ...
    for (var i in pics) {
        ...
        xhr.onload = function() {
            ...
            if (this.status == 200) {
                ...
                this.src = 'http://cdn.lfzgame.com/images/default_head.png';
            }
        ...
        xhr.onerror = function() {
            var img = document.createElement("img");
            img.src = 'http://cdn.lfzgame.com/images/default_head.png';
            imgs[this._index] = img;
            img.onload = function(e) {
                count++;
                if (count >= pics.length) draw();
...
function createRankingV2(data, func) {
    ...
    var width = 750;
    var height = 1216;
    var pics = ['http://cdn.lfzgame.com/images/decIndex/ranking_bg.jpg', 'http://cdn.lfzgame.com/images/decIndex/people_bg.png?v=1', 'http://cdn.lfzgame.com/images/decIndex/ranking_icon.png'];
    if (users.length > 6) {
        pics.push('http://cdn.lfzgame.com/images/decIndex/people_bg2.jpg');
        pics.push('http://cdn.lfzgame.com/images/decIndex/people_bg3.jpg');
        height += 102 * (users.length - 6);
    }
    for (var i in users) {
        if (/\/\/[064]{1,2}$/.test(users[i].path)) pics.push('http://cdn.lfzgame.com/images/default_head.png');
...
function appCommand(data) {
    ...
    appPassword = '房间口令：' + ['11', '12', '13', '14'][index] + data.number + '; ';
    ...
    code += '<div class="content-text">' + gameName + '(' + ['11', '12', '13', '14'][index] + data.number + ')创建完成！</div>';
...
win.token = 'gHAybg6tWIB3iOkvd0HaNfOVWiArOQMzZyWww3aI';
notice.data = '';
var user = {
    "id": "880460",
    "wechat_id": "19",
    ...
    "path": "https:\/\/wx.qlogo.cn\/mmopen\/vi_32\/Q0j4TwGTfTLU7AAZsf7SNuyMcwkfeNOIEaDAJKBLE8UrVsQ20s8EMMNcj5cG5ghd3a5OZqY03dAmGWF8rfWMCA\/64",
    "room_cards": "42"
};
...
wx.config({
    ...
    // 必填，公众号的唯一标识
    timestamp: '1514460437',
    // 必填，生成签名的时间戳
    nonceStr: 'db3c5d61f2e217e4731578df0957902a',
    // 必填，生成签名的随机串
    signature: '0dcad43b0257751c89b1e3ab0b0a84a8ceb9d2a6',
    // 必填，签名，见附录1
