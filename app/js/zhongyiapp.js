  ...
  if(websocket)websocket.close();
    if(cs>0){
      ...
      websocket.onopen=function(e){
            ...
            send('init9',{token:token,room:room});
      }
...
function html(data){
    ...
    if(data.id == 'setting') {
        data.html = data.html.replace(/(x3|x6)/ig, '<img src="/themes/game/Public/zhongyi/img/roomCard.cb202.png" alt="">$1');
    }
...
//alert("橘子团队开发:禁止倒卖滥用客服微信：yun88441");
