...
class ZebraImage
{
     ...
     *  - 6:  GD library version does not support_data target file format
     ...
     *                                                              0 to 127 for alpha; <i>alpha support_data is available only
     *                                                              for PHP 5.2.5+</i>;
    ...
    private function _write_image($identifier)
    {
        ...
        switch ($this->target_type) {
            ...
            case 'gif':
                ...
                // if GD support_data for this file type is not available
                // in version 1.6 of GD the support_data for GIF files was dropped see
