<?php
        ...
        foreach ($Room[$id]['user'] as $connection3) {
            ...
            if($Room[$id]['bank']['id']!=$connection3->user['id'] && $connection3->user['zt']=='1'){
                ...
                $jibixx[]=array(
                    'dqjf'=>$Room[$id]['user'][$connection3->user['id']]->user['dqjf'],
                    'index'=>$Room[$id]['user'][$connection3->user['id']]->user['index'],
                    'tjf'=>$Room[$id]['user'][$connection3->user['id']]->user['tjf'],
                    'tjfflower'=>$Room[$id]['user'][$connection3->user['id']]->user['tjfflower']
                );
        ...
        $jibixx[]=array(
            'dqjf'=>$Room[$id]['user'][$Room[$id]['bank']['id']]->user['dqjf'],
            'index'=>$Room[$id]['user'][$Room[$id]['bank']['id']]->user['index'],
            'fx'=>$fx,
            'tjf'=>$Room[$id]['user'][$Room[$id]['bank']['id']]->user['tjf'],
            'tjfflower'=>$Room[$id]['user'][$Room[$id]['bank']['id']]->user['tjfflower']
        );
