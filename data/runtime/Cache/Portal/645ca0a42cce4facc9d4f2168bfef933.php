...
<body>
    <div class="wrap js-check-wrap">
        <ul class="nav nav-tabs">
            ...
            <li><a href="<?php echo U('AdminYouxi/Add_Game');?>">添加游戏</a></li>
        </ul>
        <form class="well form-search" method="post" action="<?php echo U('Portal/AdminYouxi/GameList');?>">
            游戏名:
            <input type="text" name="name" style="width: 200px;" value="<?php echo ($_GET[name]); ?>" placeholder="请输入游戏名">
            <input type="submit" class="btn btn-primary js-ajax-submit" value="查找" />
            <!-- <a class="btn btn-danger" href="<?php echo U('Portal/AdminUser/expUser');?>">导出Excel</a> -->
        </form>
            ...
            <table class="table table-hover table-bordered table-list">
                ...
                <?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo U('AdminYouxi/Edit_Game',array('id'=>$vo['id']));?>" >修改</a> 

                        <!-- <a href="<?php echo U('AdminOrder/delete',array('id'=>$vo['id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a> -->
                    </td>
